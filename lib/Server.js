...
Server.prototype._manageRequest = function (req, res) {
  try {
    ...
    if (!route && this.options.public) {
      route = this._servePublicResources(req, res)
    }
...
/**
 * _servePublicResources(req, res)
 * @param {object} req
 * @param {object} res
 */
Server.prototype._servePublicResources = function (req, res) {
...
/**
 * _checkRouteParameters(path, schema, callback)
 * @param {string} path
 * @param {object} schema
 * @param {function} callback
 */
